...
if GetLocale() == "koKR" then
    ...
    L["SCAN_BANDAGE"] = "붕대"
    L["SCAN_HEALS"] = "생명력 ([%d,]+) 회복"
    L["SCAN_HEALTH"] = "생명력"
    L["SCAN_HEALTHSTONE"] = "생명석"
    L["SCAN_HPOT_STRICT"] = "생명력을 ([%d,]+)에서 ([%d,]+)만큼 회복"
    L["SCAN_HYBRID"] = "생명력과 마나" 
    L["SCAN_LIFE"] = "생명력"
    L["SCAN_MANA"] = "마나"
    L["SCAN_MPOT_STRICT"] = "마나를 ([%d,]+)에서 ([%d,]+)만큼 회복"
    L["SCAN_PERCENT"] = "([%d]+)%%만큼 회복"
    L["SCAN_REQ_FA"] = "응급치료 %((%d+)%)"
    L["SCAN_REQ_LEVEL"] = "최소 요구 레벨 (%d+)"
    L["SCAN_RESTORES"] = "([%d,]+) 회복"
    L["SCAN_SEATED"] = "앉아 있어야"
    L["SCAN_USE"] = "사용 효과:"
    L["SCAN_WELL_FED"] = "포만감"
end