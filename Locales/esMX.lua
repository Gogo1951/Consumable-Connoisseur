...
if GetLocale() == "esMX" then
    ...
    L["SCAN_BANDAGE"] = "venda"
    L["SCAN_HEALS"] = "sana ([%d,]+)"
    L["SCAN_HEALTH"] = "salud"
    L["SCAN_HEALTHSTONE"] = "piedra de salud"
    L["SCAN_HPOT_STRICT"] = "restaura ([%d,]+) a ([%d,]+) p. de salud"
    L["SCAN_HYBRID"] = "de maná y de salud" 
    L["SCAN_LIFE"] = "vida"
    L["SCAN_MANA"] = "maná"
    L["SCAN_MPOT_STRICT"] = "restaura ([%d,]+) a ([%d,]+) p. de maná"
    L["SCAN_PERCENT"] = "restaura un (%d+)%%"
    L["SCAN_REQ_FA"] = "requiere primeros auxilios %((%d+)%)"
    L["SCAN_REQ_LEVEL"] = "necesitas ser de nivel (%d+)"
    L["SCAN_RESTORES"] = "restaura ([%d,]+)"
    L["SCAN_SEATED"] = "debes permanecer sentado"
    L["SCAN_USE"] = "uso:"
    L["SCAN_WELL_FED"] = "bien alimentado"
end