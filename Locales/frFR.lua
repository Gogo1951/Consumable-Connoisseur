...
if GetLocale() == "frFR" then
    ...
    L["SCAN_HEALS"] = "rend ([%d%s]+) points"
    L["SCAN_HEALTH"] = "vie"
    L["SCAN_HEALTHSTONE"] = "pierre de soins"
    L["SCAN_HPOT_STRICT"] = "rend ([%d%s]+) à ([%d%s]+) points de vie"
    L["SCAN_HYBRID"] = "mana et de vie"
    L["SCAN_LIFE"] = "vie"
    L["SCAN_MANA"] = "mana"
    L["SCAN_MPOT_STRICT"] = "rend ([%d%s]+) à ([%d%s]+) points de mana"
    L["SCAN_PERCENT"] = "rend (%d+)%%"
    L["SCAN_REQ_FA"] = "secourisme %((%d+)%)"
    L["SCAN_REQ_LEVEL"] = "niveau (%d+) requis"
    L["SCAN_RESTORES"] = "rend ([%d%s]+)"
    L["SCAN_SEATED"] = "rester assis"
    L["SCAN_USE"] = "utiliser :"
    L["SCAN_WELL_FED"] = "bien nourri"
end