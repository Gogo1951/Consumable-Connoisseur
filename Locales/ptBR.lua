...
if GetLocale() == "ptBR" then
    ...
    L["SCAN_BANDAGE"] = "bandagem"
    L["SCAN_HEALS"] = "cura ([%d,]+)"
    L["SCAN_HEALTH"] = "vida"
    L["SCAN_HEALTHSTONE"] = "pedra de vida"
    L["SCAN_HPOT_STRICT"] = "restaura ([%d,]+) a ([%d,]+) .-de vida"
    L["SCAN_HYBRID"] = "mana e de vida" 
    L["SCAN_LIFE"] = "vida"
    L["SCAN_MANA"] = "mana"
    L["SCAN_MPOT_STRICT"] = "restaura ([%d,]+) a ([%d,]+) .-de mana"
    L["SCAN_PERCENT"] = "restaura (%d+)%%"
    L["SCAN_REQ_FA"] = "requer primeiros socorros %((%d+)%)"
    L["SCAN_REQ_LEVEL"] = "requer nível (%d+)"
    L["SCAN_RESTORES"] = "restaura ([%d,]+)"
    L["SCAN_SEATED"] = "precisa estar sentado"
    L["SCAN_USE"] = "uso:"
    L["SCAN_WELL_FED"] = "bem alimentado"
end