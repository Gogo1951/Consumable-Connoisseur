...
L["MENU_SCROLL_BUFFS_DESC"] = "Добавляет использование недостающих свитков характеристик в макрос еды, вне глобального времени восстановления."
...
L["OPTIONS_USE_SCROLLS_DESC"] = "Добавляет использование недостающих свитков характеристик в макрос еды. Свитки не зависят от ГКД, применяются к вам и исключаются из макроса, когда вы берете в цель другого дружественного игрока."
