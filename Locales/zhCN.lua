...
if GetLocale() == "zhCN" then
    ...
    L["SCAN_HEALS"] = "治疗([%d,]+)"
    L["SCAN_HEALTH"] = "生命值"
    L["SCAN_HEALTHSTONE"] = "治疗石"
    L["SCAN_HPOT_STRICT"] = "恢复([%d,]+)至([%d,]+)点生命值"
    L["SCAN_HYBRID"] = "法力值和生命值" 
    L["SCAN_LIFE"] = "生命"
    L["SCAN_MANA"] = "法力值"
    L["SCAN_MPOT_STRICT"] = "恢复([%d,]+)至([%d,]+)点法力值"
    L["SCAN_PERCENT"] = "恢复(%d+)%%"
    L["SCAN_REQ_FA"] = "需要急救 %((%d+)%)"
    L["SCAN_REQ_LEVEL"] = "需要等级 (%d+)"
    L["SCAN_RESTORES"] = "恢复([%d,]+)"
    L["SCAN_SEATED"] = "必须保持坐姿"
    L["SCAN_USE"] = "使用："
    L["SCAN_WELL_FED"] = "进食充分"
end